...
export default function UpdatePodcast() {
    ...
    const fetchingPodcast = async () => {
        ...
        try
        {
            ...
            const res = await axios.get(url + `/api/podcast/get-podcast/${podcastId}`)

            if(res.data.success)
            {
                setFormData(res.data.podcast)
    ...
    const handleSubmit = async (e) => {
        ...
        try
        {
            ...
            const res = await axios.put( url + `/api/podcast/update-podcast/${podcastId}`,formData,{headers:{token}})
