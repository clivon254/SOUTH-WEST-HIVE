...
export default function Banner2() {
  ...
  return (
    ...
    >
        ...
        <div className="w-full h-full bg-primaryLight/60 dark:bg-primaryDark/60 flex flex-col-reverse md:flex-row justify-center items-center p-2">

            <div className="banner2-title flex flex-col items-center gap-y-3 md:flex-1">

                 <p className=" text-center text-2xl font-semibold text-zinc-300">
                    From  snacks to meals ,we've got your hunger covered today
                </p>
